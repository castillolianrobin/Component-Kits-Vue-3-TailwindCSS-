<template>
  <div class="p-6">
    ...
    <div class="p-5">
        ...
        <div class="col-span-2">
          ...
          <AppCard class="p-5 mb-4">
            ...
            <div class="grid grid-cols-2 gap-3">
              ...
              label="City"></AppFormInput>
              <AppFormInput 
              v-model="personalForm.province"
              label="Province" class="col-start-1"></AppFormInput>
              <AppFormInput 
              v-model="personalForm.zipcode"
              label="Zip Code"></AppFormInput>
            </div>
          </AppCard>
        </div>
        <div>
          ...
          <div class="mt-5 flex justify-center">
            <AppBtn :disabled="!saveable" class="inline-block px-5" color="success-500">Save</AppBtn>
            <AppBtn
      ...
      <AppCard v-if="currentTab === 1" class="p-5">
        <AppFormInput
          label="Username"
          disabled
        ...
        <AppFormInput type="password"  label="New Password"></AppFormInput>
        <AppFormInput type="password" label="Retype New Password"></AppFormInput>
        <AppBtn color="success-500" class="block ml-auto">
          Reset Password
        </AppBtn>
      </AppCard>
    </div>
...
import { AppTabs, AppCard, AppFormInput, AppBtn } from "../../common/elements";
import { PencilAltIcon } from "@heroicons/vue/solid";
export default {
  components: { PencilAltIcon, AppTabs, AppCard, AppFormInput, AppBtn },
  setup() {
