      ...
      >
        ...
        >
          ...
          <div
            ...
            "
          >
            <DocumentIcon class="app-icon-lg mt-2 m-3 text-blue-600"></DocumentIcon>
...
export default {
  ...
  setup(props, context) {
    ...
    function addFile(file) {
      const _modelValue = Array.isArray(modelValue.value)
        ? modelValue.value
        : [];
    ...
    */
    ...
    function dragover(event) {
      ...
      if (!event.currentTarget.classList.contains(_hoverClass)) {
        event.currentTarget.classList.add(_hoverClass);
      }
    }
    /**
    ...
    function dragleave(event) {
      // Clean up
      event.currentTarget.classList.remove(_hoverClass);
    }
    /**
